...
public class RCC_SceneManagerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("registerLastSpawnedVehicleAsPlayerVehicle"), new GUIContent("Register Last Spawned Vehicle As Player"), false);
