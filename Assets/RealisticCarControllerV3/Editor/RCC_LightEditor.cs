...
public class RCC_LightEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        prop.overrideRenderMode = EditorGUILayout.Toggle(new GUIContent("Override RenderMode", "Ignore selected settings in RCC Settings about lights as vertex lights."), prop.overrideRenderMode);
