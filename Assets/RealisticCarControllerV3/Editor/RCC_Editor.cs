...
public class RCC_Editor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("overrideBehavior"), new GUIContent("Override Behavior", "Vehicle won't be affected by selected behavior in RCC Settings if enabled."));
        EditorGUILayout.Space();
